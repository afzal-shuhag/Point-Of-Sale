        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Suppliers List
                <a href="{{ route('suppliers.add') }}" class="btn btn-success float-right"> <i class="fa fa-plus-circle"></i> Add Supplier</a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('suppliers.edit',$supplier->id) }}" title="Edit" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> </a>

                      @if($count_supplier<1)
                        <a href="#deleteModal{{ $supplier->id }}" data-toggle="modal" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                      @endif
