        ...
        <section class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>Edit Supplier
                <a href="{{ route('suppliers.view') }}" class="btn btn-success float-right"> <i class="fa fa-list"></i>Supplier List</a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="{{ route('suppliers.update', $editData->id) }}" id="myForm">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="email" name="mobile_no" value="{{ $editData->mobile_no }}">
